...
- **New Section 9 — Off-Center Robustness Checks (`sec:offcenter`).**
...
- **New Table 1 (`tab:C_star_distribution`)** summarising the empirical
...
- **Extended verification script (`verify_bridge_theorem_v3.py`).**
  ...
  agreement checks; (ii) closed-form consistency checks;
  (iii) minimum energetic cost tables at T=300 K;
...
- **Landauer bound numerical illustration** at T=300 K, ε=10⁻².
...
- **Version 3.0** — New Section 9 (off-center robustness checks at twelve random base points); two new figures (Figs. 6–7); empirical C\* table; extended verification script v3: this directory  
