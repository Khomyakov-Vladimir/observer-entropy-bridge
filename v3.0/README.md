...
### Mirror (GitHub Releases v2.4.12)  
...
- **Version 3.0** — New Section 9 (off-center robustness checks); two new figures (Figs. 6–7); empirical C* table; extended verification script v3: [this directory](./v3.0)  
