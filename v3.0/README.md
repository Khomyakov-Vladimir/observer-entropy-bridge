...
**Version 3.0 — New Section 9 (off-center robustness checks at twelve random base points); two new figures (Figs. 6–7); empirical C\* table; quantitative validation criterion; extended verification script v3**  

**Author:** Vladimir Khomyakov — Independent Researcher  
[ORCID: 0009-0006-3074-9145](https://orcid.org/0009-0006-3074-9145)  

**DOI:** [10.5281/zenodo.20004735](https://doi.org/10.5281/zenodo.20004735)  
**Concept DOI (all versions):** [10.5281/zenodo.18826258](https://doi.org/10.5281/zenodo.18826258)  
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20004735.svg)](https://doi.org/10.5281/zenodo.20004735)  
...
This directory accompanies Version 3.0 of the article *"KL-Geometric Structure of Observer Entropy: A Minimal Information-Theoretic Framework"*. The paper constructs a self-contained geometric framework unifying the local information geometry of Kullback–Leibler divergence with an observer-dependent theory of coarse-grained entropy on finite measurable spaces.  
...
- **Off-center robustness at twelve random base points** θ*≠0  
  (new in v3.0, Section 9 of the paper)  
- **Empirical C* distribution** across all nine worked-example  
  configurations, with conservative criterion  
  rel.err(ε) ≤ 0.8·ε for ε ≤ 0.03  
...
closed-form consistency checks against Propositions 6.24
and 6.38, minimum energetic cost tables at $T=300$ K
via the Landauer bound (Theorem 8.5), and the off-center robustness checks of
...
- **Figure 6** *(new in v3.0)* — Off-center robustness check for  
  Example 1: six independent random base points θ₁*∈[-0.8,0.8] with
  random unit perturbation directions (α,β). Panel (a): log-log
  S_obs vs. quadratic prediction. Panel (b): normalised remainder
  confirming the O(ε³) bound at θ*≠0.
- **Figure 7** *(new in v3.0)* — Off-center robustness check for  
  Example 2: analogous structure for six random base points with
  random directions (α,β,γ).
...
> numbering as it appeared in the published article at version 3.0.

### Canonical record (Zenodo)  

| File | Direct URL | MD5 |  
|------|-----------|-----|  
| `observer_entropy_bridge_theorem_v3.0.pdf` | [download](https://zenodo.org/records/20004735/files/observer_entropy_bridge_theorem_v3.0.pdf) | `b9a7da3ff7887ea76b0d5dbfdefbad41` |  
| `observer_entropy_bridge_theorem_v3.0.zip` | [download](https://zenodo.org/records/20004735/files/observer_entropy_bridge_theorem_v3.0.zip) | `fca371cfdadebdd6bd2ef0632e7cad30` |  

DOI: [10.5281/zenodo.20004735](https://doi.org/10.5281/zenodo.20004735)  

### Mirror (GitHub Releases v3.0)  

| File | Permanent URL | SHA-256 |  
|------|--------------|---------|  
| `observer_entropy_bridge_theorem_v3.0.pdf` | [download](https://github.com/Khomyakov-Vladimir/observer-entropy-bridge/releases/download/v3.0/observer_entropy_bridge_theorem_v3.0.pdf) | `077a11f4792743ac1d8ffb0132639285b0539d3506522d3e55467b50f9fd25e7` |  
| `observer_entropy_bridge_theorem_v3.0.zip` | [download](https://github.com/Khomyakov-Vladimir/observer-entropy-bridge/releases/download/v3.0/observer_entropy_bridge_theorem_v3.0.zip) | `36c633ae65c4a032b12762cac5cbb3a1f65a0fc3ccf18527552c4e82b246a45e` |  

GitHub Release: [v3.0](https://github.com/Khomyakov-Vladimir/observer-entropy-bridge/releases/tag/v3.0)  
...
- **Version 3.0** — New Section 9 (off-center robustness checks at twelve random base points); two new figures (Figs. 6–7); empirical C\* table; quantitative validation criterion; extended verification script v3  
- **Version 3.12** — added discussion paragraph on frozen-in geometric structures as an open question. No change to theorems, proofs, or numerical results: see [`../v3.12/`](../v3.12/)  
