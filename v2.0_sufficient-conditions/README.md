...
> in the published article at version 2.0 and are unchanged through all subsequent
> versions (v2.1, v2.2). The numbers cited here are exact and correct for this version.

### Canonical record (Zenodo)

| File | Direct URL | MD5 |
|------|-----------|-----|
| `observer_entropy_bridge_theorem_v2.0.pdf` | [download](https://zenodo.org/records/18932260/files/observer_entropy_bridge_theorem_v2.0.pdf) | `e1d642020e0e89a46521d6f13dac74ac` |
| `observer_entropy_bridge_theorem_v2.0.zip` | [download](https://zenodo.org/records/18932260/files/observer_entropy_bridge_theorem_v2.0.zip) | `87f86b0a6c04738846f172d95e7f1bf7` |

DOI: [10.5281/zenodo.18932260](https://doi.org/10.5281/zenodo.18932260)

### Mirror (GitHub Releases v2.0)

| File | Permanent URL | SHA-256 |
|------|--------------|---------|
| `observer_entropy_bridge_theorem_v2.0.pdf` | [download](https://github.com/Khomyakov-Vladimir/observer-entropy-bridge/releases/download/v2.0/observer_entropy_bridge_theorem_v2.0.pdf) | `7c0ea73f1cb5c727b18b55ea2b8efb6258f63725e7f07758200335d557da0040` |
| `observer_entropy_bridge_theorem_v2.0.zip` | [download](https://github.com/Khomyakov-Vladimir/observer-entropy-bridge/releases/download/v2.0/observer_entropy_bridge_theorem_v2.0.zip) | `ba3494e29d893bc5ccaa68777402709a3e12011239f36e6a94db52c536dcd500` |

GitHub Release: [v2.0](https://github.com/Khomyakov-Vladimir/observer-entropy-bridge/releases/tag/v2.0)
...
- **Version 2.0** — Sufficient Conditions theorem and second worked example: this directory  
