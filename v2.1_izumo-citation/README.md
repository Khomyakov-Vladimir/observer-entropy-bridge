...
**One change only:** a citation of independently and concurrently published concurrent work has been added to the Introduction.  

The following sentence was added at the end of the Introduction (before Section 2):  

> Independently and concurrently, Izumo (2026) defines a KL-based information loss measure under discrete partitions; unlike the present work, that framework does not establish a geometric scaling law or connect to Fisher information geometry.  
