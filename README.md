...
5. **Landauer Bound (Theorem 8.5).** Thermodynamic lower bound: $E_\mathrm{min} \ge kT \cdot S_\mathrm{obs}(p,\varepsilon)$. At $T=300$ K and $\varepsilon=10^{-2}$ the verification script yields $E_\mathrm{min}\sim 10^{-25}$–$10^{-24}$ J depending on the perturbation direction.  
...
| **v3.0** | scripts ZIP | [observer_entropy_bridge_theorem_v3.0.zip](https://zenodo.org/records/20004735/files/observer_entropy_bridge_theorem_v3.0.zip) | `b5a56...1b6` | [v3.0 release](https://github.com/Khomyakov-Vladimir/observer-entropy-bridge/releases/download/v3.0/observer_entropy_bridge_theorem_v3.0.zip) | `27b99dfa...fd9` |
