...
|---------|-----------|------------|---------------|  
| **v3.0**    | [`v3.0/`](v3.0/)         | [10.5281/zenodo.20004735](https://doi.org/10.5281/zenodo.20004735) | New Section 9 (off-center robustness checks); Figs. 6–7; C* table; validation criterion; script v3 |  
