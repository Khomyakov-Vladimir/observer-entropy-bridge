...
**DOI (this version):** [10.5281/zenodo.20258280](https://doi.org/10.5281/zenodo.20258280)
...
Framework"* (version 3.24). The paper constructs a self-contained
...
- **New Section 11 — Fibre-Theoretic Foundation.** The equivalence
  ...
  reduction $\pi^{*}\pi_{*}\mu$.
- **Exact closed-form identity (Theorem 11.8):**
...
8. **Fibre-Theoretic Foundation (Section 11, NEW in v3.24).**
   ...
   $S_\mathrm{obs}^\mathrm{fib}(\mu) = \log N - H_\mathrm{w}(\mu)$
   (Theorem 11.8), valid for every strictly positive measure on
...
- **Fibre-theoretic identities (NEW in v3.24):**
  ...
  (Theorem 11.8) for both balanced and unbalanced fibres,
...
```
observer_entropy_bridge_theorem_v3.24/
├── README.md
├── LICENSE
├── requirements.txt
├── scripts/
│   └── verify_bridge_theorem_v3.24.py
└── figures/
...
Theorem 11.8. The verification script
`verify_bridge_theorem_v3.24.py` includes all checks from v3 plus
...
- **Supplementary Figure (Fibre identity)** — scatter plot of
  ...
  Theorem 11.8 for balanced and unbalanced fibres.
...
```bash
python scripts/verify_bridge_theorem_v3.24.py
```
...
A Minimal Information-Theoretic Framework*, Version 3.24 (2026).
DOI: [10.5281/zenodo.20258280](https://doi.org/10.5281/zenodo.20258280)
