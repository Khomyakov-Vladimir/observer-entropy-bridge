...
**Version 2.4.24 — Resolved scoping inconsistency in `as:deformation` and `thm:bridge`; logically closed version**  

**Author:** Vladimir Khomyakov — Independent Researcher  
[ORCID: 0009-0006-3074-9145](https://orcid.org/0009-0006-3074-9145)  

**DOI:** [10.5281/zenodo.19883297](https://doi.org/10.5281/zenodo.19883297)  
...
This directory accompanies Version 2.4.24 of the article *"KL-Geometric Structure of Observer Entropy: A Minimal Information-Theoretic Framework"*. The paper constructs a self-contained geometric framework unifying the local information geometry of Kullback–Leibler divergence with an observer-dependent theory of coarse-grained entropy on finite measurable spaces.  
...
> (Theorem 6.7, Theorem 6.43, Theorem 7.4, Corollary 7.7, Theorem 7.10, Corollary 7.14,  
> Theorem 8.3, Theorem 8.5, Proposition 9.5) reflect the numbering as it appeared  
> in the published article. These numbers are unchanged relative to v2.0 and remain  
> correct for version v2.4.24.  

### Canonical record (Zenodo)  

| File | Direct URL | MD5 |  
|------|-----------|-----|  
| `observer_entropy_bridge_theorem_v2.4.24.pdf` | [download](https://zenodo.org/records/19883297/files/observer_entropy_bridge_theorem_v2.4.24.pdf) | `f80a55a607796795a9820581ed9a9981` |  
| `observer_entropy_bridge_theorem_v2.4.24.zip` | [download](https://zenodo.org/records/19883297/files/observer_entropy_bridge_theorem_v2.4.24.zip) | `e49036c49d9e6fd4ba5241ea3bcfeb85` |  
...
|------|--------------|---------|  
| `observer_entropy_bridge_theorem_v2.4.24.pdf` | [download](https://github.com/Khomyakov-Vladimir/observer-entropy-bridge/releases/download/v2.4.24/observer_entropy_bridge_theorem_v2.4.24.pdf) | `80e52d306b1fae1a7ec3941c88473ee77a9dd0006a660c49af0781c2164841c2` |  
| `observer_entropy_bridge_theorem_v2.4.24.zip` | [download](https://github.com/Khomyakov-Vladimir/observer-entropy-bridge/releases/download/v2.4.24/observer_entropy_bridge_theorem_v2.4.24.zip) | `964aec3c887d8b9328eb8ca50378bb52032f74840f89a5900bd642c73a83d457` |  

GitHub Release: [v2.4.24](https://github.com/Khomyakov-Vladimir/observer-entropy-bridge/releases/tag/v2.4.24)  
...
Vladimir Khomyakov, *KL-Geometric Structure of Observer Entropy: A Minimal Information-Theoretic Framework*, Version 2.4.24 (2026). DOI: [10.5281/zenodo.19883297](https://doi.org/10.5281/zenodo.19883297)  
